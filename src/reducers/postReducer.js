import { GET_ALLPOST,GET_ALLPOST_ERROR,ADD_NEW_NOTE, REMOVE_NOTE, EDIT_NOTE } from "../const/index";
...
export const getPostsData = state => state.posts;
